# Custom OTA Update System Deep Architecture
...
C++17, C++ Design Patterns, SOLID, ESP32/STM32, Dual partition, MCUboot, ECDSA, TLS, Rollback logic, Embedded Linux
...
- Test coverage: `tests/OtaUpdateTests.cpp`

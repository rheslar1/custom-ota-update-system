...
| --- | --- | --- |
| FR-001 | Provide a deterministic host-buildable runtime for Custom OTA Update System. | CMake/CTest or equivalent CI. |
| FR-002 | Implement the project focus: Secure dual-partition firmware update flow for ESP32 or STM32 with signed image verification, staged rollouts, and automatic fallback. | Scenario tests and documentation review. |

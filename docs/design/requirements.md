# Custom OTA Update System Requirements

## Functional Requirements

| ID | Requirement | Verification |
| --- | --- | --- |
| FR-001 | The system shall expose a deterministic host-buildable runtime for Custom OTA Update System. | CMake/CTest smoke run. |
| FR-002 | The system shall model the project focus: Secure dual-partition firmware update flow for ESP32 or STM32 with signed image verification, staged rollouts, and automatic fallback. | Scenario tests and documentation review. |
